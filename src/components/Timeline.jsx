      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            ...
            Online course on R, biostatistics, Generalized Linear Models, ordination and data visualization, focusing on ecology.
          </div>
          <hr />
        </li>
        <li>
        ...
        <li>
          ...
          <div className="timeline-end md:mb-10">
            ...
            Biodiversity, ecology, and conservation of amphibians and reptiles.
          </div>
          <hr />
        </li>
        <li>
        ...
        <li>
          ...
          <div className="timeline-end md:mb-10">
            ...
            Includes nine diving specialties.
          </div>
          <hr />
        </li>
        <li>
